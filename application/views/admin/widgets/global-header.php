...
<nav class="uk-navbar cma-navbar">
	...
	<div class="uk-navbar-flip">
		<ul class="uk-navbar-nav">
			<li class="uk-navbar-content uk-hidden-small"><i class="uk-icon-user"></i> <em>Logged in as <?php echo $username; ?></em></li>
...
<div class="uk-panel uk-panel-box uk-panel-box-primary uk-visible-small">
	This part of the site was not designed for smaller devices.  Some functionality may not work as intended.
</div>