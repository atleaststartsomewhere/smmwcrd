	...
	<div class="uk-grid">
		<div class="uk-width-1-1">
			<div class="uk-panel uk-panel-box uk-panel-box-primary">
				...
				<span class="">Add, Update or Delete items from your calendar.  Use the month/year the drop-downs below to <button class="uk-button uk-button-link uk-button-mini">GO <i class="uk-icon-arrow-circle-o-right"></i></button> to a desired month/year.</span>
