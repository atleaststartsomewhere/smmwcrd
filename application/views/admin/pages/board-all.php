...
<div class="uk-width-1-3 uk-container-center">
	<ul class="uk-subnav uk-subnav-pill">
		<li><a href="<?php echo $links['board-member'];?>"><i class="uk-icon uk-icon-plus"></i> Add </a></li>
		...
		<li class="uk-active"><a href="<?php echo $links['board-all'];?>"><i class="uk-icon uk-icon-cog"></i> Manage All</a></li>
	</ul>
</div>
<article class="uk-article">
	<?php echo form_open($scripts['scriptboard'].'/manage', 'class="uk-form uk-form-horizontal"'); ?>

	<div class="uk-grid">
		<div class="uk-width-1-1">
			<div class="uk-panel uk-panel-box uk-panel-box-primary">
				<span class="">Click and drag the <i class="uk-icon uk-icon-align-justify uk-icon-button uk-icon-small"></i> icon to re-order board members.</span>
			</div>
			<?php if ( empty($members) ) : ?>
				<span>No Board Members to display. Click <a href="<?php echo $links['board-member']; ?>">Here</a> to add one.</span>
			<?php else : ?>
					...
					<?php foreach ( $members as $member ) : ?>
						<div class="uk-form-row">
							<div class="uk-grid uk-grid-condensed">
								...
								<div class="uk-width-1-6">
									<a href="<?php echo $links['board-member'].'/'.$member->id; ?>">Edit Member</a>
								</div>
								<div class="uk-width-1-6">
