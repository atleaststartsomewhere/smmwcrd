...
<article class="uk-article">
	...
	<div class="uk-grid">
		<div class="uk-width-2-3">
			...
			<legend class="uk-text-primary">Board of Directors</legend>
			<?php if ( empty($members) ) : ?>
				<span>No Board Members to display. Click <a href="<?php echo $links['board-member']; ?>">Here</a> to add one.</span>
			<?php else : ?>
				<span class="uk-form-help-inline uk-text-small">Click and Drag <i class="uk-icon uk-icon-align-justify uk-icon-button uk-icon-small"></i> to re-order board members</span>
