	...
	<div class="Page__content">
		<div class="Address">
			...
			<address class="Address__mailing">
				<h3 class="Address__heading">Mailing Address</h3><?php echo $address_one; ?><br><?php echo $address_two; ?>
			</address>
			<address class="Address__delivery">
				<h3 class="Address__heading">Deliveries</h3><?php echo $deliveries_one; ?><br><?php echo $deliveries_two; ?>
			</address>
		</div>
	</div>
</section>