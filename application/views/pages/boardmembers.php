			...
			<section class="Page">
				<div class="Page__subNav">
					<ul class="Page__subNav__list">
						...
						<li class="Page__subNav__list__item"><a href="<?php echo $links['boardmembers']; ?>" class="active">Board Members</a></li>
				...
				<div class="Page__content">
					<ul class="Page__content__list">
						<?php foreach ( $board as $member ) : ?>
							<li class="Page__content__list__item StaffMember"><span class="Page__content__list__item__name"><?php echo $member->name; ?><br /><small><?php echo $member->title; ?></small></span>
